...
import cjefimg1 from './chef1.png';
import cjefimg2 from './cooking2.png';
import waiterimg from './waiter.png';
import blankimg from './0.png';
import tableimg from './table3.png';

document.querySelector("#cjefimg1").src=cjefimg1;
document.querySelector("#cjefimg2").src=cjefimg2;
document.getElementsByClassName("seat").forEach(eachseat => {
    console.log(eachseat.name);
    eachseat.getElementsByTagName("img")[0].src=blankimg;
    eachseat.getElementsByTagName("img")[1].src=tableimg;
});
console.log(document.querySelector("#waiter img").name);
document.querySelector("#waiter img").src=waiterimg;
...
document.querySelector("#startbut").addEventListener("click",startBunsiness);
...
var addchef=function(){
    if(cheflist.length<5){
        ...
        newchefdiv.id="chef";
        newchefimg1.src=cjefimg1;
        newchefimg2.src=cjefimg2;
...
document.querySelector("#addchefbut").addEventListener("click",addchef);
...
document.querySelector("#addwaiterbut").addEventListener("click",addwaiter);
